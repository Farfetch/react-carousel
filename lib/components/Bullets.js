...
var _Bullets = _interopRequireDefault(require("./Bullets.css"));
...
var Bullets = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Bullets, [{
    ...
    value: function render() {
      ...
      }, otherProps), isInfinite ? /*#__PURE__*/_react["default"].createElement("div", {
        className: _Bullets["default"].moveInfinite,
        style: {
    ...
    value: function getBullets() {
      ...
      var getCxInfinite = function getCxInfinite(index) {
        ...
        return (0, _classnames["default"])(_Bullets["default"].bulletInfinite, (_cx = {}, _defineProperty(_cx, _Bullets["default"].isActive, activeBullet === index), _defineProperty(_cx, _Bullets["default"].isSecondary, secondaryBullets.first === index || secondaryBullets.second === index), _defineProperty(_cx, theme.isActive, theme.isActive && activeItem === index), _cx));
      };

      var getCxDefault = function getCxDefault(index) {
        var _cx2;

        return (0, _classnames["default"])(_Bullets["default"].bullet, (_cx2 = {}, _defineProperty(_cx2, _Bullets["default"].isActive, activeBullet === index), _defineProperty(_cx2, theme.isActive, theme.isActive && activeItem === index), _cx2));
      };

      var generateClass = isInfinite ? getCxInfinite : getCxDefault;

      for (var i = 0; i < bullets; i++) {
        itemsNodes.push( /*#__PURE__*/_react["default"].createElement("span", {
          key: i,
    ...
    value: function getClassNamesToApply() {
      ...
      if (isInfinite) {
        return (0, _classnames["default"])(_Bullets["default"].containerInfinite, _objectSpread(_objectSpread({}, baseThemeClasses), {}, _defineProperty({}, theme.containerInfinite, !!theme.containerInfinite)));
      }

      return (0, _classnames["default"])(_Bullets["default"].containerDefault, _objectSpread(_objectSpread({}, baseThemeClasses), {}, _defineProperty({}, theme.containerDefault, !!theme.containerDefault)));
    }
  }]);
...
Bullets.propTypes = {
  ...
  theme: _propTypes["default"].shape({
    ...
    containerDefault: _propTypes["default"].string,
    containerInfinite: _propTypes["default"].string,
    moveInfinite: _propTypes["default"].string,
    bullet: _propTypes["default"].string,
    bulletInfinite: _propTypes["default"].string,
    isSecondary: _propTypes["default"].string,
    isActive: _propTypes["default"].string
  }),

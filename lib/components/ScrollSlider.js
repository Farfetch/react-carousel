...
var ScrollSlider = /*#__PURE__*/function (_Component) {
  ...
  function ScrollSlider(props) {
    ...
    _this._verifyActiveItemDebounce = (0, _debounce["default"])(_this._verifyActiveItem, 25);
    _this._handleScroll = _this._handleScroll.bind(_assertThisInitialized(_this));
    _this.itemsLength = _react.Children.count(props.children);
    _this.activeItem = 0;
  ...
  _createClass(ScrollSlider, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", _extends({
        ...
        className: (0, _classnames["default"])(_Slider["default"].slider, _ScrollSlider["default"].container, className),
        onScroll: this._handleScroll
      }, othersProps), (0, _utils.renderSlides)(children, itemsToShow, style));
    }
  }, {
    key: "_moveToItem",
    value: function _moveToItem() {
      ...
      (0, _utils.animateScroll)(el, finalPosition, 0.3, function () {
...
ScrollSlider.propTypes = {
  ...
  limitScroll: _propTypes["default"].bool
};
var _default = ScrollSlider;
